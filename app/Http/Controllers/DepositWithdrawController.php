...
class DepositWithdrawController extends Controller
{
    ...
    public function store(Request $request)
    {
        try
        {
            ...
            {
                createTransaction($request->accountID, $request->date, $request->amount, 0, "Deposit: ".$request->notes, $ref, "Deposit");
            }
            else
            {
                createTransaction($request->accountID, $request->date, 0, $request->amount, "Withdraw: ".$request->notes, $ref, "Withdraw");
            }
