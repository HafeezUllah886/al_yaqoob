...
class SalePaymentsController extends Controller
{
    ...
    public function store(Request $request)
    {
        try{
            ...
            createTransaction($request->accountID, $request->date,$request->amount, 0, "Payment of Inv No. $sale->id", $ref, 'Sale');
            createTransaction($sale->customerID, $request->date,$request->amount, 0, "Payment of Inv No. $sale->id", $ref, 'Sale');
