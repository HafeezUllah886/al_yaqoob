...
class PurchasePaymentsController extends Controller
{
    ...
    public function store(Request $request)
    {
        try{
            ...
            createTransaction($request->accountID, $request->date, 0, $request->amount, "Payment of Purchase No. $purchase->id", $ref, 'Purchase');
            createTransaction($purchase->vendorID, $request->date, $request->amount, 0, "Payment of Purchase No. $purchase->id", $ref, 'Purchase');
