                        ...
                        <div class="row">
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody id="products_list">
                                        @foreach ($purchase->details as $product)
                                            ...
                                            <tr id="row_{{ $id }}">
                                                <td class="no-padding">
                                                    {{ $product->product->code . ' | ' . $product->product->name }}</td>
                                                <td class="no-padding">
                                                    <select name="unit[]" class="form-control text-center"
                                                        ...
                                                        @foreach ($units as $unit)
                                                            ...
                                                            <option data-unit="{{ $unit->value }}"
                                                                value="{{ $unit->id }}" @selected($unit->id == $product->unitID)>
                                                                {{ $unit->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td class="no-padding">
                                                    <input type="number" name="qty[]"
                                                        oninput="updateChanges({{ $id }})" min="0.1"
                                                        required step="any" value="{{ $product->qty / $unitValue }}"
                                                        class="form-control text-center" id="qty_{{ $id }}">
                                                </td>
                                                <td class="no-padding"><input type="number" name="pprice[]"
                                                        oninput="updateChanges({{ $id }})" required
                                                        step="any" value="{{ $product->pprice }}" min="1"
                                                ...
                                                <td class="no-padding"><input type="number" name="price[]" required
                                                        ...
                                                        class="form-control text-center no-padding"
                                                        id="price_{{ $id }}"></td>
                                                <td class="no-padding"><input type="number" name="wsprice[]" required
                                                        step="any" value="{{ $product->wsprice }}" min="1"
                                                        class="form-control text-center no-padding"
                                                        id="wsprice_{{ $id }}"></td>
                                                <td class="no-padding"><input type="number" name="tp[]" required
                                                        step="any" value="{{ $product->tp }}" min="1"
                                                        class="form-control text-center no-padding"
                                                        id="tp_{{ $id }}"></td>
                                                <td class="no-padding"><input type="number" name="gstValue[]" readonly
                                                        required step="any" value="{{ $product->gstValue }}"
                                                        class="form-control text-center no-padding"
                                                        id="gstValue_{{ $id }}"></td>
                                                <td class="no-padding"><input type="number" name="amount[]" min="0.1"
                                                        readonly required step="any" value="{{ $product->amount }}"
                                                        class="form-control text-center no-padding"
                                                        id="amount_{{ $id }}"></td>
                                                <td class="no-padding"><input type="number" name="bonus[]"
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="inv" value="{{ $purchase->inv }}" id="inv"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="discount" value="{{ $purchase->discount }}"
                                        oninput="updateTotal()" id="discount" step="any" value="0"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="fright" id="fright" value="{{ $purchase->fright }}"
                                        oninput="updateTotal()" min="0" step="any" value="0"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="fright1" id="fright1"
                                        value="{{ $purchase->fright1 }}" oninput="updateTotal()" min="0"
                                        step="any" value="0" class="form-control">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" name="whTax" id="whTax" value="{{ $purchase->wh }}"
                                            oninput="updateTotal()" max="50" min="0" step="any"
                                            value="0" aria-describedby="basic-addon2" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="warehouseID" id="warehouse" class="selectize1">
                                        @foreach ($warehouses as $warehouse)
                                            <option value="{{ $warehouse->id }}" @selected($warehouse->id == $purchase->warehouseID)>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="vendorID" id="vendor" class="selectize1">
                                        @foreach ($vendors as $vendor)
                                            <option value="{{ $vendor->id }}" @selected($vendor->id == $purchase->vendorID)>
                                                {{ $vendor->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-12 mt-2">
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody id="expenses">
                                        @foreach ($purchase->expenses as $key => $expense)
                                            @php
                                                $expense_ser = $key + 1;
                                            @endphp
                                            <tr id="expense_{{ $expense_ser }}">
                                                <td>
                                                    <select name="category[]" required class="form-control">
                                                        <option value="">Select Category</option>
                                                        @foreach ($expense_categories as $category)
                                                            <option value="{{ $category->id }}"
                                                                @selected($category->id == $expense->cat)>
                                                    ...
                                                    <select name="expense_account[]" required class="form-control">
                                                        ...
                                                        @foreach ($accounts as $account)
                                                            <option value="{{ $account->id }}"
                                                                @selected($account->id == $expense->accountID)>
                                                ...
                                                <td>
                                                    <span class="btn btn-sm btn-danger"
                                                        onclick="deleteExpense({{ $expense_ser }})">X</span>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
...
@section('page-js')
    ...
    <script>
                    ...
                    if (found.length > 0) {
                        ...
                        units.forEach(function(unit) {
                            ...
                            html += '<option data-unit="' + unit.value + '" value="' + unit.id + '" ' +
                                (isSelected ? 'selected' : '') + '>' + unit.name + '</option>';
                        });
                        html += '</select></td>';
                        html +=
                            '<td class="no-padding"><input type="number" name="qty[]" oninput="updateChanges(' +
                            id +
                            ')" min="0" required step="any" value="0" class="form-control text-center no-padding" id="qty_' +
                            id + '"></td>';

                        html +=
                            '<td class="no-padding"><input type="number" name="pprice[]" oninput="updateChanges(' +
                            id + ')" required step="any" value="' + product.pprice +
                            '" min="1" class="form-control text-center no-padding" id="pprice_' + id +
                            '"></td>';
                        html +=
                            '<td class="no-padding"><input type="number" name="price[]" required step="any" value="' +
                            product.price + '" min="0" class="form-control text-center no-padding" id="price_' +
                            id + '"></td>';
                        html +=
                            '<td class="no-padding"><input type="number" name="wsprice[]" required step="any" value="' +
                            product.wsprice +
                            '" min="1" class="form-control text-center no-padding" id="wsprice_' + id +
                            '"></td>';
                        html +=
                            '<td class="no-padding"><input type="number" name="tp[]" required step="any" value="' +
                            product.tp + '" min="1" class="form-control text-center no-padding" id="tp_' + id +
                            '"></td>';
                        html +=
                            '<td class="no-padding"><input type="number" name="gstValue[]" readonly required step="any" value="0" class="form-control text-center no-padding" id="gstValue_' +
                            id + '"></td>';
                        html +=
                            ...
                            id + '"></td>';
                        html +=
                            '<td class="no-padding"><input type="number" name="bonus[]" min="0" required step="any" value="0" oninput="updateChanges(' +
                            id + ')" class="form-control text-center no-padding" id="bonus_' + id + '"></td>';
                        html +=
        ...
        var expense_ser = {{ $purchase->expenses->count() }};
