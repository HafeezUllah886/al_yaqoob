                                ...
                                <div id="edit_{{ $product_unit->id }}" class="modal fade" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('product_units.update', $product_unit->id) }}"
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group mt-2">
                                                        ...
                                                        <input type="text" name="unit_name" required id="unit_name"
                                                            value="{{ $product_unit->unit_name }}" class="form-control">
                                                    </div>
                                                    <div class="form-group mt-2">
