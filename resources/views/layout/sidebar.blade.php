     ...
     <ul class="side-nav">
         ...
         <li class="side-nav-item">
             ...
             <div class="collapse" id="dashboards">
                 <ul class="sub-menu">
                     <li class="side-nav-item">
                         <a href="index-1.html" class="side-nav-link">
         ...
         <li class="side-nav-item">
             ...
             <div class="collapse" id="ecommerce">
                 <ul class="sub-menu">
                             ...
                             <ul class="sub-menu">
                                 ...
                                 <li class="side-nav-item">
                                     <a href="apps-ecommerce-products-grid.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="apps-ecommerce-products-grid">Products
                                             Grid</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="apps-ecommerce-product-details.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="apps-ecommerce-product-details">Product
                                             Details</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                     ...
                     <li class="side-nav-item">
                         <a href="apps-ecommerce-cart.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-ecommerce-cart">Cart</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-ecommerce-checkout.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-ecommerce-checkout">Checkout</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a data-bs-toggle="collapse" href="#sellers" aria-expanded="false" aria-controls="sellers"
                             class="side-nav-link">
                         ...
                         <div class="collapse" id="sellers">
                             <ul class="sub-menu">
                                 ...
                                 <li class="side-nav-item">
                                     <a href="apps-ecommerce-seller-details.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="apps-ecommerce-seller-details">Sellers
                                             Details</span>
                                     </a>
                                 </li>
                             </ul>
                     ...
                     <li class="side-nav-item">
                         <a href="apps-ecommerce-refunds.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-ecommerce-refunds">Refunds</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-ecommerce-reviews.html" class="side-nav-link">
                     ...
                     <li class="side-nav-item">
                         ...
                         <div class="collapse" id="inventory">
                             <ul class="sub-menu">
                                 <li class="side-nav-item">
                                     <a href="apps-ecommerce-warehouse.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="apps-ecommerce-warehouse">Warehouse</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="apps-ecommerce-product-stocks.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="apps-ecommerce-product-stocks">Product
                                             Stocks</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="apps-ecommerce-purchased-orders.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="apps-ecommerce-purchased-orders">Purchased
                                             Orders</span>
                                     </a>
                                 </li>
                             </ul>
                     ...
                     <li class="side-nav-item">
                         ...
                         <div class="collapse" id="reports">
                             <ul class="sub-menu">
                                 <li class="side-nav-item">
                                     <a href="apps-ecommerce-product-views.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="apps-ecommerce-product-views">Product
                                             Views</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="apps-ecommerce-sales.html" class="side-nav-link">
                     ...
                     <li class="side-nav-item">
                         <a href="apps-ecommerce-attributes.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-ecommerce-attributes">Attributes</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-ecommerce-settings.html" class="side-nav-link">
         ...
         <li class="side-nav-item">
             ...
             <div class="collapse" id="projects">
                 <ul class="sub-menu">
                     <li class="side-nav-item">
                         <a href="apps-projects-grid.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-projects-grid">My Projects</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-projects-list.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-projects-list">Projects
                                 List</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-projects-details.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-projects-details">View
                                 Project</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-projects-kanban.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-projects-kanban">Kanban
                                 Board</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-projects-team-board.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-projects-team-board">Team
                                 Board</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-projects-activity.html" class="side-nav-link">
                 ...
                 <ul class="sub-menu">
                     ...
                     <li class="side-nav-item">
                         <a href="apps-task-details.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-task-details">Task
                                 Details</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                 ...
                 <ul class="sub-menu">
                     ...
                     <li class="side-nav-item">
                         <a href="apps-invoice-create.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-invoice-create">New
                                 Invoice</span>
                         </a>
                     </li>
                 </ul>
         ...
         <li class="side-nav-item">
             ...
             <div class="collapse" id="users">
                 <ul class="sub-menu">
                     <li class="side-nav-item">
                         <a href="apps-users-contacts.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-users-contacts">Contacts</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-users-profile.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-users-profile">Profile</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-users-account-settings.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-users-account-settings">Account
                                 Settings</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-users-roles.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-users-roles">Roles</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-users-role-details.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-users-role-details">Role
                                 Details</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-users-permissions.html" class="side-nav-link">
         ...
         <li class="side-nav-item">
             ...
             <div class="collapse" id="finance">
                 <ul class="sub-menu">
                             ...
                             <ul class="sub-menu">
                                 ...
                                 <li class="side-nav-item">
                                     <a href="apps-finance-expense-category.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="apps-finance-expense-category">Expense
                                             Category</span>
                                     </a>
                                 </li>
                             </ul>
                     ...
                     <li class="side-nav-item">
                         <a href="apps-finance-banks-cards.html" class="side-nav-link">
         ...
         <li class="side-nav-item">
             ...
             <div class="collapse" id="hrm">
                 <ul class="sub-menu">
                     <li class="side-nav-item">
                         <a data-bs-toggle="collapse" href="#staffs" aria-expanded="false" aria-controls="staffs"
                             class="side-nav-link">
                         ...
                         <div class="collapse" id="staffs">
                             <ul class="sub-menu">
                                 <li class="side-nav-item">
                                     <a href="apps-hrm-staffs.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="apps-hrm-staffs">Staffs
                                             List</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="apps-hrm-staff-profile.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="apps-hrm-staff-profile">Staff
                                             Profile</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="apps-hrm-staff-add.html" class="side-nav-link">
                     ...
                     <li class="side-nav-item">
                         <a href="apps-hrm-departments.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-hrm-departments">Departments</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-hrm-attendance.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-hrm-attendance">Attendance</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a data-bs-toggle="collapse" href="#leaves" aria-expanded="false" aria-controls="leaves"
                             class="side-nav-link">
                         ...
                         <div class="collapse" id="leaves">
                             <ul class="sub-menu">
                                 <li class="side-nav-item">
                                     <a href="apps-hrm-leaves.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="apps-hrm-leaves">Leaves</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="apps-hrm-leave-add.html" class="side-nav-link">
                     ...
                     <li class="side-nav-item">
                         <a href="apps-hrm-holidays.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-hrm-holidays">Holidays</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-hrm-payroll.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-hrm-payroll">Payroll</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-hrm-create-salary-slip.html" class="side-nav-link">
         ...
         <li class="side-nav-item">
             <a data-bs-toggle="collapse" href="#email" aria-expanded="false" aria-controls="email"
                 ...
                 <span class="badge text-bg-danger ms-auto">New</span>
             </a>
             <div class="collapse" id="email">
                 <ul class="sub-menu">
                     <li class="side-nav-item">
                         <a href="apps-email-inbox.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-email-inbox">Inbox</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-email-details.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-email-details">Details</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-email-compose.html" class="side-nav-link">
         ...
         <li class="side-nav-item">
             ...
             <div class="collapse" id="promo">
                 <ul class="sub-menu">
                     ...
                     <li class="side-nav-item">
                         <a href="apps-promo-gift-cards.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-promo-gift-cards">Gift
                                 Cards</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-promo-discounts.html" class="side-nav-link">
         ...
         <li class="side-nav-item">
             ...
             <div class="collapse" id="more-apps">
                 <ul class="sub-menu">
                     ...
                     <li class="side-nav-item">
                         <a href="apps-pro-ai.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-pro-ai">Pro AI</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-file-manager.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-file-manager">File
                                 Manager</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                     ...
                     <li class="side-nav-item">
                         <a href="apps-todo.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-todo">Todo</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-pin-board.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-pin-board">Pin Board</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-clients.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-clients">Clients</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-outlook.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-outlook">Outlook View</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-vote-list.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-vote-list">Vote List</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-issue-tracker.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-issue-tracker">Issue
                                 Tracker</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-api-keys.html" class="side-nav-link">
                             <span class="menu-text" data-lang="apps-api-keys">API Keys</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="apps-manage.html" class="side-nav-link">
                     ...
                     <li class="side-nav-item">
                         ...
                         <div class="collapse" id="blog">
                             <ul class="sub-menu">
                                 <li class="side-nav-item">
                                     <a href="apps-blog-list.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="apps-blog-list">Blog
                                             List</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="apps-blog-grid.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="apps-blog-grid">Blog
                                             Grid</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="apps-blog-article.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="apps-blog-article">Article</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="apps-blog-add.html" class="side-nav-link">
                     ...
                     <li class="side-nav-item">
                         <a data-bs-toggle="collapse" href="#forum" aria-expanded="false" aria-controls="forum"
                             class="side-nav-link">
                         ...
                         <div class="collapse" id="forum">
                             <ul class="sub-menu">
                                 <li class="side-nav-item">
                                     <a href="apps-forum-view.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="apps-forum-view">Forum
                                             View</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="apps-forum-post.html" class="side-nav-link">
                 ...
                 <ul class="sub-menu">
                     <li class="side-nav-item">
                         <a href="plugins-sortable.html" class="side-nav-link">
                             <span class="menu-text" data-lang="plugins-sortable">Sortable
                                 List</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                     ...
                     <li class="side-nav-item">
                         <a href="plugins-sweet-alerts.html" class="side-nav-link">
                             <span class="menu-text" data-lang="plugins-sweet-alerts">Sweet
                                 Alerts</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                     ...
                     <li class="side-nav-item">
                         <a href="plugins-pass-meter.html" class="side-nav-link">
                             <span class="menu-text" data-lang="plugins-pass-meter">Password
                                 Meter</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                     ...
                     <li class="side-nav-item">
                         <a href="plugins-video-player.html" class="side-nav-link">
                             <span class="menu-text" data-lang="plugins-video-player">Video
                                 Player</span>
                         </a>
                     </li>
                 </ul>
         ...
         <li class="side-nav-item">
             <a data-bs-toggle="collapse" href="#authentication" aria-expanded="false"
                 aria-controls="authentication" class="side-nav-link">
             ...
             <div class="collapse" id="authentication">
                 <ul class="sub-menu">
                     <li class="side-nav-item">
                         <a data-bs-toggle="collapse" href="#auth-basic" aria-expanded="false"
                             aria-controls="auth-basic" class="side-nav-link">
                             ...
                             <ul class="sub-menu">
                                 <li class="side-nav-item">
                                     <a href="auth-sign-in.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="auth-sign-in">Sign
                                             In</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="auth-sign-up.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="auth-sign-up">Sign
                                             Up</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                 ...
                                 <li class="side-nav-item">
                                     <a href="auth-new-pass.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="auth-new-pass">New
                                             Password</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="auth-two-factor.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="auth-two-factor">Two
                                             Factor</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                 ...
                                 <li class="side-nav-item">
                                     <a href="auth-login-pin.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="auth-login-pin">Login
                                             with PIN</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                     ...
                     <li class="side-nav-item">
                         <a data-bs-toggle="collapse" href="#auth-card" aria-expanded="false"
                             aria-controls="auth-card" class="side-nav-link">
                             ...
                             <ul class="sub-menu">
                                 <li class="side-nav-item">
                                     <a href="auth-card-sign-in.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="auth-card-sign-in">Sign
                                             In</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="auth-card-sign-up.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="auth-card-sign-up">Sign
                                             Up</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="auth-card-reset-pass.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="auth-card-reset-pass">Reset
                                             Password</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="auth-card-new-pass.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="auth-card-new-pass">New
                                             Password</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="auth-card-two-factor.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="auth-card-two-factor">Two
                                             Factor</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="auth-card-lock-screen.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="auth-card-lock-screen">Lock
                                             Screen</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="auth-card-success-mail.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="auth-card-success-mail">Success
                                             Mail</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="auth-card-login-pin.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="auth-card-login-pin">Login with
                                             PIN</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="auth-card-delete-account.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="auth-card-delete-account">Delete
                                             Account</span>
                                     </a>
                                 </li>
                             </ul>
                     ...
                     <li class="side-nav-item">
                         <a data-bs-toggle="collapse" href="#auth-split" aria-expanded="false"
                             aria-controls="auth-split" class="side-nav-link">
                             ...
                             <ul class="sub-menu">
                                 <li class="side-nav-item">
                                     <a href="auth-split-sign-in.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="auth-split-sign-in">Sign
                                             In</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="auth-split-sign-up.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="auth-split-sign-up">Sign
                                             Up</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
         ...
         <li class="side-nav-item">
             <a data-bs-toggle="collapse" href="#error-pages" aria-expanded="false" aria-controls="error-pages"
                 class="side-nav-link">
                 ...
                 <ul class="sub-menu">
                     <li class="side-nav-item">
                         <a href="layouts-sidebar-light.html" class="side-nav-link" target="_blank">
                             <span class="menu-text" data-lang="layouts-sidebar-light">Light
                                 Menu</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                     ...
                     <li class="side-nav-item">
                         <a href="layouts-sidebar-gray.html" class="side-nav-link" target="_blank">
                             <span class="menu-text" data-lang="layouts-sidebar-gray">Gray
                                 Menu</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="layouts-sidebar-image.html" class="side-nav-link" target="_blank">
                             <span class="menu-text" data-lang="layouts-sidebar-image">Image
                                 Menu</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                     ...
                     <li class="side-nav-item">
                         <a href="layouts-sidebar-no-icons.html" class="side-nav-link" target="_blank">
                             <span class="menu-text" data-lang="layouts-sidebar-no-icons">No Icons
                                 with Lines</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="layouts-sidebar-with-lines.html" class="side-nav-link" target="_blank">
                             <span class="menu-text" data-lang="layouts-sidebar-with-lines">Sidebar
                                 with Lines</span>
                         </a>
                     </li>
                 </ul>
                 ...
                 <ul class="sub-menu">
                     <li class="side-nav-item">
                         <a href="layouts-topbar-dark.html" class="side-nav-link" target="_blank">
                             <span class="menu-text" data-lang="layouts-topbar-dark">Dark
                                 Topbar</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="layouts-topbar-gray.html" class="side-nav-link" target="_blank">
                             <span class="menu-text" data-lang="layouts-topbar-gray">Gray
                                 Topbar</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                 ...
                 <ul class="sub-menu">
                     ...
                     <li class="side-nav-item">
                         <a href="form-text-editors.html" class="side-nav-link">
                             <span class="menu-text" data-lang="form-text-editors">Text
                                 Editors</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                         <a href="form-range-slider.html" class="side-nav-link">
                             <span class="menu-text" data-lang="form-range-slider">Range
                                 Slider</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
                     ...
                     <li class="side-nav-item">
                         <a href="form-other-plugin.html" class="side-nav-link">
                             <span class="menu-text" data-lang="form-other-plugin">Other
                                 Plugins</span>
                         </a>
                     </li>
                 </ul>
                 ...
                 <ul class="sub-menu">
                     ...
                     <li class="side-nav-item">
                         <a data-bs-toggle="collapse" href="#datatables" aria-expanded="false"
                             ...
                             <span class="badge text-bg-success ms-auto">15</span>
                         </a>
                             ...
                             <ul class="sub-menu">
                                 ...
                                 <li class="side-nav-item">
                                     <a href="tables-datatables-javascript.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="tables-datatables-javascript">Javascript
                                             Source</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                 ...
                                 <li class="side-nav-item">
                                     <a href="tables-datatables-fixed-columns.html" class="side-nav-link">
                                         <span class="menu-text" data-lang="tables-datatables-fixed-columns">Fixed
                                             Columns</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                 ...
                 <ul class="sub-menu">
                     ...
                     <li class="side-nav-item">
                         <a href="icons-solar-duotone.html" class="side-nav-link">
                             <span class="menu-text" data-lang="icons-solar-duotone">Solar
                                 Duotone</span>
                         </a>
                     </li>
                     <li class="side-nav-item">
         ...
         <li class="side-nav-item">
             <a data-bs-toggle="collapse" href="#menu-levels" aria-expanded="false" aria-controls="menu-levels"
                 class="side-nav-link">
                             ...
                             <ul class="sub-menu">
                                 <li class="side-nav-item">
                                     <a href="#" class="side-nav-link">
                                         <span class="menu-text" data-lang="menu-item-1">Item
                                             2.1</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a href="#" class="side-nav-link">
                                         <span class="menu-text" data-lang="menu-item-2">Item
                                             2.2</span>
                                     </a>
                                 </li>
                             </ul>
                     ...
                     <li class="side-nav-item">
                         ...
                         <div class="collapse" id="second-level-2">
                             <ul class="sub-menu">
                                 <li class="side-nav-item">
                                     <a href="#" class="side-nav-link">
                                         <span class="menu-text" data-lang="menu-item-3">Item
                                             2.1</span>
                                     </a>
                                 </li>
                                 <li class="side-nav-item">
                                     <a data-bs-toggle="collapse" href="#menu-item-4" aria-expanded="false"
                                         ...
                                         <span class="menu-text" data-lang="menu-item-4">Item
                                             2.2</span>
                                         <span class="menu-arrow"></span>
                                     </a>
