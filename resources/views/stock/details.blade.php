                        ...
                        <div class="card-header border-bottom-dashed p-4">
                            <div class="d-flex">
                                ...
                                <div class="flex-shrink-0 mt-sm-0 mt-3">
                                    <h3>Product Stock</h3>
                                    <h5 class="text-capitalize">{{ $branch }}</h5>
                                </div>
                            </div>
                        </div>
                        <!--end card-header-->
                        ...
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <div class="col-lg-3 col-6">
                                    ...
                                    <h5 class="fs-14 mb-0">Unit: {{ $unit->unit_name }}</h5>
                                </div>
                                <!--end col-->
                                <div class="col-lg-3 col-6">
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <h5 class="fs-14 mb-0"><small class="text-muted" id="invoice-time">Current Balance
                                            &nbsp;</small><span
                                            id="invoice-date">{{ number_format($cur_balance / $unit->value) }}</span> </h5>
                                    <h5 class="fs-14 mb-0"><small class="text-muted" id="invoice-time">Previous Balance
                                        </small><span
                                            id="invoice-date">{{ number_format($pre_balance / $unit->value) }}</span> </h5>
                                </div>
                                <!--end col-->
                                <div class="col-lg-3 col-6">
                                    <p class="text-muted mb-2 text-uppercase fw-semibold">Printed_On</p>
                                    ...
                                    <tbody id="products-list">
                                        ...
                                        @foreach ($stocks as $key => $stock)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">{{ number_format($stock->cr / $unit->value) }}</td>
                                                <td class="text-end">{{ number_format($stock->db / $unit->value) }}</td>
                                                <td class="text-end">{{ number_format($balance / $unit->value) }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table><!--end table-->
