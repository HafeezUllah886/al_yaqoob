        ...
        <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="input-group mb-3">
                            ...
                            <select name="branch_id" id="branch_id_filter" class="form-control">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h3>Non-Business Expenses</h3>
                    <div>
                        <a href="{{ route('nonBusinessExpensesCategories.index') }}" class="btn btn-info ">Categories</a>
                        ...
                        <tbody>
                            @foreach ($expenses as $key => $tran)
                                <tr>
                                    ...
                                    <td>
                                        @if ($tran->source == 'Non-Business Expense')
                                            <a href="{{ route('non_business_expense.delete', $tran->refID) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Create Non-Business Expense </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
                </div>
                <form action="{{ route('nonBusinessExpenses.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
