                        ...
                        <div class="card-header border-bottom-dashed p-4">
                            <div class="d-flex">
                                ...
                                <div class="flex-shrink-0 mt-sm-0 mt-3">
                                    ...
                                    <p class="text-muted mb-2 text-uppercase fw-semibold">{{ $account->branch->name }}</p>
                                </div>
                            </div>
                        </div>
                        <!--end card-header-->
                        ...
                        <div class="card-body p-4">
                            <div class="row g-3">
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <h5 class="fs-14 mb-0"><small class="text-muted" id="invoice-time">Current
                                            &nbsp;</small><span id="invoice-date">Rs.
                                            {{ number_format($cur_balance) }}</span> </h5>
                                    <h5 class="fs-14 mb-0"><small class="text-muted" id="invoice-time">Previous
                                        </small><span id="invoice-date">Rs. {{ number_format($pre_balance) }}</span> </h5>
                                </div>
                                <!--end col-->
                                <div class="col-lg-3 col-6">
